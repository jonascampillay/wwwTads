		...
		try {
			do {
				...
				case 4:
					...
					break;
				case 5:
					 System.out.println("Lista de contas atualizada: \n" +
				...
				case 7:
					...
					HandlerAgencia.aplicaViraMes(agencia);
				case 0:
					sair = true;
					break;
	...
	public static void menuDados() {
		...
		try {
			do {
				...
				case 2:
					HandlerArquivo.gravaObj(listaAgencia, "agencia");
					HandlerArquivo.gravaObj(listaGerente, "gerente");
					HandlerArquivo.gravaObj(listaCliente, "cliente");
					HandlerArquivo.gravaObj(listaFuncionario, "funcionario");
