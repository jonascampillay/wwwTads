...
public class HandlerConta {
	...
	public static void extrato(Agencia agencia2) {
		...
		if (agencia2 != null) {
			...
			try {
				...
				do {
					...
					switch (op1) {
					case 1:
						ContaPoupanca contaAux1 = HandlerContaPoupanca.consultaContaP(agencia2);

						if (contaAux1 != null) {
							String extrato1 = contaAux1.extrato();
					...
					case 2:
						...
						ContaCorrente contaAux2 = HandlerContaCorrente.consultaContaC(agencia2);

						if (contaAux2 != null) {
							String extrato2 = contaAux2.extrato();
							System.out.println(extrato2);
