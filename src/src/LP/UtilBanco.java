	...
	public static void operacoesConta(Conta conta) {
		...
		do {
			...
			case 1:
				...
				Saque operacao = new Saque(conta, valor);
			...
			case 2:
				...
				Depositar operacao2 = new Depositar(conta, valor2);
					...
					do {
						...
						case 1:
							...
							if (contaAux1 != null) {
								...
								Transferencia operacao3 = new Transferencia(valor3, conta, contaAux1);
						...
						case 2:
							...
							if (contaAux2 != null) {
								...
								Transferencia operacao4 = new Transferencia(valor4, conta, contaAux2);
