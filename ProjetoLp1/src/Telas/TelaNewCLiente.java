...
public class TelaNewCLiente {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaNewCLiente window = new TelaNewCLiente();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\Hiago Brazzali\\Documents\\wwwTads\\ProjetoLp1\\src\\Imagens\\iconVoltar.png"));
